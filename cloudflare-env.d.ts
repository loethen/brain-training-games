/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e462fb6703723fd3f0aaa7ceaa778c55)
...
declare namespace Cloudflare {
	interface Env {
		...
		EXT_PUBLIC_GOOGLE_ADSENSE_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "GEMINI_API_KEY" | "EXT_PUBLIC_GOOGLE_ADSENSE_ID">> {}
}
