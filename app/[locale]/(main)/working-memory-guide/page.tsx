                    ...
                    <div className="bg-card border p-6 rounded-lg">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <div>
                                    <h5 className="font-medium text-foreground font-semibold">{t('memory.hippocampus.causes.cause1.title')}</h5>
                                    <p className="text-sm text-muted-foreground">{t('memory.hippocampus.causes.cause1.p')}</p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-foreground font-semibold">{t('memory.hippocampus.causes.cause2.title')}</h5>
                                    <p className="text-sm text-muted-foreground">{t('memory.hippocampus.causes.cause2.p')}</p>
                                </div>
                            </div>
                            <div className="space-y-3">
                                <div>
                                    <h5 className="font-medium text-foreground font-semibold">{t('memory.hippocampus.causes.cause3.title')}</h5>
                                    <p className="text-sm text-muted-foreground">{t('memory.hippocampus.causes.cause3.p')}</p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-foreground font-semibold">{t('memory.hippocampus.causes.cause4.title')}</h5>
