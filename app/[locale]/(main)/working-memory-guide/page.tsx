        ...
        <article className="prose prose-lg max-w-none mb-16">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 p-4 rounded-lg">
                                <h5 className="font-semibold mb-2 text-blue-800 dark:text-blue-200">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card1.title"
                                    )}
                                </h5>
                                <p className="text-sm text-blue-600 dark:text-blue-300">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card1.p"
                                    )}
                                </p>
                            </div>
                            <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 p-4 rounded-lg">
                                <h5 className="font-semibold mb-2 text-green-800 dark:text-green-200">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card2.title"
                                    )}
                                </h5>
                                <p className="text-sm text-green-600 dark:text-green-300">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card2.p"
                                    )}
                                </p>
                            </div>
                            <div className="bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 p-4 rounded-lg">
                                <h5 className="font-semibold mb-2 text-purple-800 dark:text-purple-200">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card3.title"
                                    )}
                                </h5>
                                <p className="text-sm text-purple-600 dark:text-purple-300">
                                    {t(
                                        "introduction.whatIs.baddeleyModel.card3.p"
                                    )}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="bg-card border p-6 rounded-lg">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "introduction.neuroscience.keyAreas.li1"
                                    ),
                                }}
                            />
                            <li
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "introduction.neuroscience.keyAreas.li2"
                                    ),
                                }}
                            />
                            <li
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "introduction.neuroscience.keyAreas.li3"
                                    ),
                                }}
                            />
                            <li
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "introduction.neuroscience.keyAreas.li4"
                                    ),
                                }}
                            />
                        </ul>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li>
                                    {t("introduction.dailyImpact.academic.li1")}
                                </li>
                                <li>
                                    {t("introduction.dailyImpact.academic.li2")}
                                </li>
                                <li>
                                    {t("introduction.dailyImpact.academic.li3")}
                                </li>
                                <li>
                                    {t("introduction.dailyImpact.academic.li4")}
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li>
                                    {t(
                                        "introduction.dailyImpact.workplace.li1"
                                    )}
                                </li>
                                <li>
                                    {t(
                                        "introduction.dailyImpact.workplace.li2"
                                    )}
                                </li>
                                <li>
                                    {t(
                                        "introduction.dailyImpact.workplace.li3"
                                    )}
                                </li>
                                <li>
                                    {t(
                                        "introduction.dailyImpact.workplace.li4"
                                    )}
                                </li>
                            </ul>
                        </div>
            ...
            <section id="dual-n-back" className="mb-16 content-section">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                <h5 className="font-medium mb-2">
                                    {t(
                                        "dnb.jaeggiStudy.coreFindings.design.title"
                                    )}
                                </h5>
                                <ul className="space-y-1 text-sm">
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.design.li1"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.design.li2"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.design.li3"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.design.li4"
                                        )}
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h5 className="font-medium mb-2">
                                    {t(
                                        "dnb.jaeggiStudy.coreFindings.results.title"
                                    )}
                                </h5>
                                <ul className="space-y-1 text-sm">
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.results.li1"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.results.li2"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.results.li3"
                                        )}
                                    </li>
                                    <li>
                                        {t(
                                            "dnb.jaeggiStudy.coreFindings.results.li4"
                                        )}
                                    </li>
                                </ul>
                            </div>
                ...
                <div id="dual-n-back-1" className="mb-10">
                    ...
                    <div className="space-y-6 bg-slate-50 dark:bg-slate-900/50 p-6 rounded-lg">
                        <div>
                            <h4 className="font-semibold mb-3">
                                {t("dnb.mechanism.card1.title")}
                            </h4>
                            <p className="text-sm mb-3">
                                {t("dnb.mechanism.card1.p")}
                            </p>
                            <div
                                className="text-xs text-muted-foreground"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "dnb.mechanism.card1.details"
                                    ),
                                }}
                            />
                        </div>
                        <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                            <h4 className="font-semibold mb-3">
                                {t("dnb.mechanism.card2.title")}
                            </h4>
                            <p className="text-sm mb-3">
                                {t("dnb.mechanism.card2.p")}
                            </p>
                        ...
                        <div className="border-t border-slate-200 dark:border-slate-700 pt-6">
                            <h4 className="font-semibold mb-3">
                                {t("dnb.mechanism.card3.title")}
                            </h4>
                            <p className="text-sm mb-3">
                                {t("dnb.mechanism.card3.p")}
                            </p>
                            <div className="text-xs text-muted-foreground">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-card border rounded-lg p-6">
                            <h4 className="font-semibold mb-4 text-foreground">
                                {t("dnb.neuroplasticity.structural.title")}
                            </h4>
                            <ul className="space-y-2 text-sm">
                                <li>
                                    {t("dnb.neuroplasticity.structural.li1")}
                                </li>
                                <li>
                                    {t("dnb.neuroplasticity.structural.li2")}
                                </li>
                                <li>
                                    {t("dnb.neuroplasticity.structural.li3")}
                                </li>
                            </ul>
                        </div>
                        <div className="bg-card border rounded-lg p-6">
                            <h4 className="font-semibold mb-4 text-foreground">
                                {t("dnb.neuroplasticity.functional.title")}
                            </h4>
                            <ul className="space-y-2 text-sm">
                                <li>
                                    {t("dnb.neuroplasticity.functional.li1")}
                                </li>
                                <li>
                                    {t("dnb.neuroplasticity.functional.li2")}
                                </li>
                                <li>
                                    {t("dnb.neuroplasticity.functional.li3")}
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="dual-n-back-3" className="mb-10">
                    ...
                    <div className="bg-card border p-6 rounded-lg">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <h5 className="font-medium mb-2">
                                    {t("dnb.protocol.expectations.title")}
                                </h5>
                                <ul className="space-y-1 text-sm text-muted-foreground">
                                    <li>
                                        {t("dnb.protocol.expectations.li1")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.expectations.li2")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.expectations.li3")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.expectations.li4")}
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h5 className="font-medium mb-2">
                                    {t("dnb.protocol.successFactors.title")}
                                </h5>
                                <ul className="space-y-1 text-sm">
                                    <li>
                                        {t("dnb.protocol.successFactors.li1")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.successFactors.li2")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.successFactors.li3")}
                                    </li>
                                    <li>
                                        {t("dnb.protocol.successFactors.li4")}
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section id="schulte-table" className="mb-16 content-section">
                ...
                <div id="schulte-table-0" className="mb-10">
                    <h3 className="text-2xl font-semibold mb-6">
                        {t("schulte.posnerTheory.title")}
                    </h3>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                        {t("schulte.posnerTheory.p1")}
                    </p>
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-3 text-amber-800 dark:text-amber-200">
                                {t("schulte.posnerTheory.card1.title")}
                            </h4>
                            <p className="text-sm mb-3 text-amber-700 dark:text-amber-300">
                                {t("schulte.posnerTheory.card1.p")}
                            </p>
                            <div
                                className="text-xs text-amber-600 dark:text-amber-400"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "schulte.posnerTheory.card1.details"
                                    ),
                                }}
                            />
                        </div>
                        <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-3 text-emerald-800 dark:text-emerald-200">
                                {t("schulte.posnerTheory.card2.title")}
                            </h4>
                            <p className="text-sm mb-3 text-emerald-700 dark:text-emerald-300">
                                {t("schulte.posnerTheory.card2.p")}
                            </p>
                            <div
                                className="text-xs text-emerald-600 dark:text-emerald-400"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "schulte.posnerTheory.card2.details"
                                    ),
                                }}
                            />
                        </div>
                        <div className="bg-violet-50 dark:bg-violet-950/30 border border-violet-200 dark:border-violet-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-3 text-violet-800 dark:text-violet-200">
                                {t("schulte.posnerTheory.card3.title")}
                            </h4>
                            <p className="text-sm mb-3 text-violet-700 dark:text-violet-300">
                                {t("schulte.posnerTheory.card3.p")}
                            </p>
                            <div
                                className="text-xs text-violet-600 dark:text-violet-400"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "schulte.posnerTheory.card3.details"
                                    ),
                                }}
                            />
                        </div>
                ...
                <div id="schulte-table-1" className="mb-10">
                    ...
                    <div className="space-y-6">
                        <div className="bg-card border p-6 rounded-lg">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h5 className="font-medium mb-2">
                                        {t(
                                            "schulte.readingSpeed.russiaStudy.visual.title"
                                        )}
                                    </h5>
                                    <ul
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t.raw(
                                                "schulte.readingSpeed.russiaStudy.visual.list"
                                            ),
                                        }}
                                    />
                                </div>
                                <div>
                                    <h5 className="font-medium mb-2">
                                        {t(
                                            "schulte.readingSpeed.russiaStudy.reading.title"
                                        )}
                                    </h5>
                                    <ul
                                        className="space-y-1 text-sm"
                                        dangerouslySetInnerHTML={{
                                            __html: t.raw(
                                                "schulte.readingSpeed.russiaStudy.reading.list"
                                            ),
                                        }}
                                    />
                                </div>
                        ...
                        <div className="bg-card border p-6 rounded-lg">
                            <h4 className="font-semibold mb-4">
                                {t(
                                    "schulte.readingSpeed.psychologyStudy.title"
                                )}
                            </h4>
                            <p className="text-sm mb-3">
                                {t("schulte.readingSpeed.psychologyStudy.p1")}
                            </p>
                            <ul
                                className="space-y-1 text-sm"
                                dangerouslySetInnerHTML={{
                                    __html: t.raw(
                                        "schulte.readingSpeed.psychologyStudy.list"
                                    ),
                                }}
                            />
                        </div>
            ...
            <section id="memory-improvement" className="mb-16 content-section">
                ...
                <div id="memory-improvement-0" className="mb-10">
                    <h3 className="text-2xl font-semibold mb-6">
                        {t("memory.hippocampus.title")}
                    </h3>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                        {t("memory.hippocampus.p1")}
                    </p>
                    <div className="bg-card border p-6 rounded-lg">
                        <h4 className="font-semibold mb-4">
                            {t("memory.hippocampus.causes.title")}
                        </h4>
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <div>
                                    <h5 className="text-foreground font-semibold">
                                        {t(
                                            "memory.hippocampus.causes.cause1.title"
                                        )}
                                    </h5>
                                    <p className="text-sm text-muted-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause1.p"
                                        )}
                                    </p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause2.title"
                                        )}
                                    </h5>
                                    <p className="text-sm text-muted-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause2.p"
                                        )}
                                    </p>
                                </div>
                            </div>
                            <div className="space-y-3">
                                <div>
                                    <h5 className="font-medium text-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause3.title"
                                        )}
                                    </h5>
                                    <p className="text-sm text-muted-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause3.p"
                                        )}
                                    </p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause4.title"
                                        )}
                                    </h5>
                                    <p className="text-sm text-muted-foreground">
                                        {t(
                                            "memory.hippocampus.causes.cause4.p"
                                        )}
                                    </p>
                                </div>
                            </div>
            ...
            <section id="training-protocol" className="mb-16 content-section">
                ...
                <div id="training-protocol-0" className="mb-10">
                    <h3 className="text-2xl font-semibold mb-6">
                        {t("trainingProtocol.personalized.title")}
                    </h3>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                        {t("trainingProtocol.personalized.p1")}
                    </p>
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-4 text-green-800 dark:text-green-200">
                                {t(
                                    "trainingProtocol.personalized.beginner.title"
                                )}
                            </h4>
                            <div className="space-y-3">
                                <div>
                                    <h5 className="font-medium text-sm">
                                        {t(
                                            "trainingProtocol.personalized.audience"
                                        )}
                                    </h5>
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.beginner.audience"
                                        )}
                                    </p>
                                </div>
                                <div>
                                    <h5 className="font-medium text-sm">
                                        {t(
                                            "trainingProtocol.personalized.focus"
                                        )}
                                    </h5>
                                    <ul
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t.raw(
                                                "trainingProtocol.personalized.beginner.focus"
                                            ),
                                        }}
                                    />
                                </div>
                                <div>
                                    <h5 className="font-medium text-sm">
                                        {t(
                                            "trainingProtocol.personalized.effect"
                                        )}
                                    </h5>
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.beginner.effect"
                                        )}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-4 text-blue-800 dark:text-blue-200">
                                {t(
                                    "trainingProtocol.personalized.advanced.title"
                                )}
                            </h4>
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.advanced.audience"
                                        )}
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <ul
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t.raw(
                                                "trainingProtocol.personalized.advanced.focus"
                                            ),
                                        }}
                                    />
                                </div>
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.advanced.effect"
                                        )}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 p-6 rounded-lg">
                            <h4 className="font-semibold mb-4 text-purple-800 dark:text-purple-200">
                                {t(
                                    "trainingProtocol.personalized.expert.title"
                                )}
                            </h4>
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.expert.audience"
                                        )}
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <ul
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: t.raw(
                                                "trainingProtocol.personalized.expert.focus"
                                            ),
                                        }}
                                    />
                                </div>
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            "trainingProtocol.personalized.expert.effect"
                                        )}
                                    </p>
                                </div>
                            </div>
