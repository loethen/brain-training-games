...
export const metadata: Metadata = {
    ...
    description:
        "Improve memory, concentration and cognitive skills with free science-based brain games for all ages. Perfect for kids, adults, and seniors looking to boost focus and attention.",
    ...
    openGraph: {
        ...
        description:
            "Enhance focus, memory and concentration with free science-based cognitive games. Featuring Schulte Table, Pattern Recall Challenge, and more brain-boosting activities.",
