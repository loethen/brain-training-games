...
export default function FishTracePage() {
  return (
    <GamePageTemplate
      ...
      howToPlay={
        <>
          <p>Follow the glowing fish in this underwater tracking challenge:</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Watch carefully as certain fish glow with colored circles</li>
            <li>Keep tracking those fish even after the circles disappear</li>
            <li>When prompted, click on the fish that had the glowing circles</li>
            <li>As you improve, more fish will appear and move faster</li>
          </ul>
        </>
      }
      benefits={[
        {
          ...
          description: "Improve your ability to follow moving objects and maintain visual focus in dynamic environments."
        },
        {
          icon: <Focus className="w-10 h-10" />,
          title: "Sustained Attention",
          description: "Enhance your capacity to maintain concentration on specific targets over extended periods."
        },
        {
          icon: <Target className="w-10 h-10" />,
          title: "Selective Attention",
          description: "Develop your ability to focus on relevant stimuli while ignoring distractions."
        }
      ]}
      faq={[
        {
          question: "How does visual tracking training benefit everyday life?",
