...
// Dynamically import the Dual N-Back game component (assuming default export)
const DualNBackGameComponent = dynamic(
  () => import('@/app/[locale]/(main)/games/dual-n-back/components/GameComponent'),
  {
...
export default function DualNBackEmbedPage() {
  return (
