          ...
          <section className="prose prose-lg mx-auto mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                  <div>
                      ...
                      <p>
                          Train your sequential memory by remembering and
                          repeating increasingly complex patterns.
                      </p>
                  </div>
                  <div>
                      <h3 className="text-xl font-semibold mb-2">
                      ...
                      <p>
                          ...
                          reproducing color and sound sequences.
                      </p>
                  </div>
                  <div>
                      <h3 className="text-xl font-semibold mb-2">
          ...
          <section className="max-w-3xl mx-auto mb-16">
              ...
              <div className="space-y-4">
                  <details className="bg-muted/50 rounded-lg p-4">
                      ...
                      <p className="mt-2">
                          Simon challenges your sequential memory by requiring
                          you to remember and reproduce increasingly complex
                          patterns of colors and sounds, helping strengthen your
                          working memory and pattern recognition abilities.
                      </p>
                  </details>
                  <details className="bg-muted/50 rounded-lg p-4">
                      <summary className="font-semibold cursor-pointer">
                      ...
                      <p className="mt-2">
                          For best results, try playing Simon for 15-20 minutes
                          daily. The game naturally increases in difficulty as
                          you improve, making it an excellent tool for
