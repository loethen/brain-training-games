...
export default function MahjongDualNBackPage() {
  return (
      <GamePageTemplate
          gameBackground="bg-[radial-gradient(circle,#2a9d5c_0%,#1e7a47_100%)]"
          ...
          howToPlay={
              <>
                  <p>
                      In this challenging memory task, you&apos;ll need to
                      remember both symbols and colors from N steps back in the
                      sequence:
                  </p>
                  <ul className="list-disc pl-5 mt-2 space-y-1">
                      <li>
                          Watch the mahjong tiles as they appear in sequence
                      </li>
                      <li>
                          Press &quot;Symbol&quot; when the current symbol
                          matches the symbol from N steps back
                      </li>
                      <li>
                          Press &quot;Color&quot; when the current color matches
                          the color from N steps back
                      </li>
                      <li>
                          Use keyboard shortcuts: &apos;A&apos; for Symbol
                          match, &apos;L&apos; for Color match
                      </li>
                  </ul>
              </>
          }
          benefits={[
              {
                  ...
                  description:
                      "Strengthen your ability to hold and manipulate information in your mind temporarily.",
              },
              {
                  icon: <Layers className="w-10 h-10" />,
                  title: "Fluid Intelligence",
                  description:
                      "Improve your capacity to solve novel problems and adapt to new situations.",
              },
              {
                  icon: <Zap className="w-10 h-10" />,
                  title: "Attention Control",
                  description:
                      "Enhance your ability to focus on relevant information while ignoring distractions.",
              },
          ]}
          faq={[
              {
